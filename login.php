...
<html>
<head>
<title>Online Library System Login</title>
<link rel="shortcut icon" HREF="img/brow.png" />
...
<form class="box login" method="POST">
	<label align="center"><font size="6" color="grey">Online Library System</font></label>
